      ...
      <div className="App">
        <Routes>
          ...
          <Route path="/join" element={
            meetingJoined ? <Navigate to="/meeting" /> : <Join handleCreateMeeting={handleCreateMeeting} handleJoinMeeting={handleJoinMeeting} username={username} />
          } />
          ...
          <Route path="/" element={
            !isLoggedIn ? <Navigate to="/login" /> : <Navigate to="/join" />
          } />
        </Routes>
      </div>
    </Router>
